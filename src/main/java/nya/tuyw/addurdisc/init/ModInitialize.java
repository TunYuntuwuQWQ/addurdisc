        ...
        if (event.getRegistryKey().equals(ForgeRegistries.SOUND_EVENTS.getRegistryKey())) {
            ...
            for (String name : loadedSounds) {
                event.register(ForgeRegistries.SOUND_EVENTS.getRegistryKey(),
                        ...
                        () ->  new SoundEvent(new ResourceLocation(AddurDisc.MODID,name)));
            }
        }
    }
        ...
        if (event.getRegistryKey().equals(ForgeRegistries.ITEMS.getRegistryKey())) {
            for (String name : loadedSounds) {
                ...
                if (soundEvent != null) {
                    ...
                    Item recordItem = new RecordItem(15, () -> soundEvent, new Item.Properties().stacksTo(1).rarity(Rarity.RARE).tab(TAB), 1728000);
