...
public class myRepositorySource implements RepositorySource {  //copy from FolderRepositorySource,but enabled by default.<change in #38>
    ...
    public myRepositorySource(File p_10386_, PackSource p_10387_) {
    ...
    public void loadPacks(Consumer<Pack> p_10391_, Pack.PackConstructor p_10392_) {
        ...
        if (afile != null) {
            for(File file1 : afile) {
                ...
                Pack pack = Pack.create(s, true, this.createSupplier(file1), p_10392_, Pack.Position.TOP, this.packSource);
                if (pack != null) {
